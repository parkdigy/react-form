...
export interface PFormCheckboxCommands
  extends
    Omit<PFormValueItemBaseCommands<PFormCheckboxValue, false>, 'getReset'>,
...
export interface PFormCheckboxProps
  extends
    PCommonSxProps,
    Omit<CheckboxProps, 'ref' | 'size' | 'color' | 'name' | 'inputRef' | 'action' | 'required' | 'onChange'>,
    Omit<PFormValueItemProps<PFormCheckboxValue, false>, 'value' | 'onChange'> {
