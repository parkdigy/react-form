...
const CustomDatePickerContainer = React.forwardRef<CustomDatePickerContainerCommands, Props>(
  (
    {
      selectType,
      value,
    ...
    const datePicker1Ref = useRef<CustomDatePickerCommands>(null);
    const datePicker2Ref = useRef<CustomDatePickerCommands>(null);
    const datePicker3Ref = useRef<CustomDatePickerCommands>(null);
    ...
    useLayoutEffect(() => {
      if (ref) {
        const commands: CustomDatePickerContainerCommands = {
          previousMonth,
          nextMonth,
          activeMonth,
        };
...
CustomDatePickerContainer.defaultProps = CustomDatePickerContainerDefaultProps;
