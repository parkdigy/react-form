import { FormValueItemProps, FormValueItemBaseCommands, FormYearMonthValueItemCommands } from '../../@types';
...
export const FormMonthPickerDefaultProps: Required<
  Pick<FormMonthPickerProps, 'format' | 'formValueYearNameSuffix' | 'formValueMonthNameSuffix'>
> = {
  format: 'YYYY년 MM월',
