...
function checkDateAvailable(date, availableDate, type, time) {
    ...
    return (React__default.createElement(FormContextProvider, { value: __assign$6({ id: formId || 'form', variant: variant, size: size, color: color, spacing: spacing, formColGap: formColGap, focused: focused, labelShrink: labelShrink, fullWidth: fullWidth, fullHeight: fullHeight, onAddValueItem: function (id, item) {
                valueItems[id] = item;
                if (formAddValueItem)
...
};var StyledLineDiv = styled('div')(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject(["\n  border-bottom: thin solid #dfdfdf;\n  position: absolute;\n  left: 0;\n  top: 50%;\n  width: 100%;\n"], ["\n  border-bottom: thin solid #dfdfdf;\n  position: absolute;\n  left: 0;\n  top: 50%;\n  width: 100%;\n"])));
...
function useResizeDetector(props) {
    ...
    // Render ----------------------------------------------------------------------------------------------------------
    return (React__default.createElement(FormContextProvider, { value: __assign$6({ variant: variant, size: size, color: color, spacing: spacing, focused: focused, labelShrink: labelShrink, fullWidth: fullWidth, formColXs: xs || formColAutoXs || 12, formColWidth: formColWidth, formColWithLabel: !!label, formColWithHelperText: !!helperText }, otherFormState) },
...
var templateObject_1$1, templateObject_2;var FormBody = function (_a) {
    ...
    return (React__default.createElement(StyledContainerDiv, { ref: fullHeight ? resizeDetectorRef : undefined, className: 'FormBody', style: style },
...
FormTextField.defaultProps = FormTextFieldDefaultProps;var FormTextDefaultProps = __assign$6(__assign$6({}, FormTextFieldDefaultProps), { clear: true, value: '' });var FormText = React__default.forwardRef(function (_a, ref) {
    // Event Handler ---------------------------------------------------------------------------------------------------
...
styleInject(css_248z$i);var FormHidden = React__default.forwardRef(function (_a, ref) {
    ...
    return (React__default.createElement(FormText, __assign$6({ ref: ref, className: classNames$1(className, 'FormHidden'), type: 'hidden', variant: 'standard' }, props)));
});
...
styleInject(css_248z$h);var FormTag = React__default.forwardRef(function (_a, ref) {
    ...
    return (React__default.createElement(FormContextProvider, { value: __assign$6({ fullWidth: formFullWidth, onAddValueItem: handleAddValueItem, 
        ...
        React__default.createElement(Autocomplete, { options: [], multiple: true, freeSolo: true, value: value, readOnly: readOnly, disableClearable: true, disabled: disabled, renderTags: handleRenderTags, inputValue: inputValue, style: { display: fullWidth ? 'block' : 'inline-block', width: fullWidth ? '100%' : undefined }, renderInput: function (params) {
                ...
                return (React__default.createElement(FormText, __assign$6({}, renderProps, { ref: handleRef, name: name, className: classNames$1(className, 'FormValueItem', 'FormTag'), error: error, disabled: disabled, fullWidth: fullWidth, required: required, value: inputValue, exceptValue: exceptValue, helperText: helperText, onKeyDown: handleInputKeyDown, onChange: handleInputChange, onBlur: handleBlur })));
            } })));
});
FormTag.displayName = 'FormTag';
FormTag.defaultProps = FormTagDefaultProps;var FormEmailDefaultProps = __assign$6(__assign$6({}, FormTextDefaultProps), { validPattern: /^(([^<>()[\].,;:\s@"]+(\.[^<>()[\].,;:\s@"]+)*)|(".+"))@(([^<>()[\].,;:\s@"]+\.)+[^<>()[\].,;:\s@"]{2,})$/g });var FormEmail = React__default.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest$3(_a, ["className"]);
    return React__default.createElement(FormText, __assign$6({ ref: ref, className: classNames$1(className, 'FormEmail'), type: 'email' }, props));
});
...
var FormPassword = React__default.forwardRef(function (_a, ref) {
    ...
    // Render ----------------------------------------------------------------------------------------------------------
    return (React__default.createElement(FormText, __assign$6({ ref: ref, className: classNames$1(className, 'FormPassword'), onChange: handleChange, type: type, InputProps: muiInputProps }, props)));
});
FormPassword.displayName = 'FormPassword';
FormPassword.defaultProps = FormPasswordDefaultProps;
var templateObject_1;var FormTelDefaultProps = __assign$6(__assign$6({}, FormTextDefaultProps), { validPattern: /(^([0-9]{2,3})([0-9]{3,4})([0-9]{4})$)|(^([0-9]{2,3})-([0-9]{3,4})-([0-9]{4})$)|(^([0-9]{4})-([0-9]{4})$)|(^\+(?:[-]?[0-9]){8,}$)/ });var FormTel = React__default.forwardRef(function (_a, ref) {
    // Event Handler ---------------------------------------------------------------------------------------------------
    var className = _a.className, onValue = _a.onValue, props = __rest$3(_a, ["className", "onValue"]);
    ...
    // Render ----------------------------------------------------------------------------------------------------------
    return (React__default.createElement(FormText, __assign$6({ ref: ref, className: classNames$1(className, 'FormTel'), onValue: handleOnValue, maxLength: 13 }, props)));
});
...
function getTelAutoDash(tel) {
    ...
    return tmp;
}var FormMobileDefaultProps = __assign$6(__assign$6({}, FormTelDefaultProps), { validPattern: /(^(01(?:0|1|[6-9]))([0-9]{3,4})([0-9]{4,4})$)|(^(01(?:0|1|[6-9]))-([0-9]{3,4})-([0-9]{4,4})$)|(^\+(?:[-]?[0-9]){8,}$)/ });var FormMobile = React__default.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest$3(_a, ["className"]);
    return React__default.createElement(FormTel, __assign$6({ ref: ref, className: classNames$1(className, 'FormMobile') }, props));
});
...
NumberFormat.defaultProps = defaultProps;var NumberFormatCustom = React__default.forwardRef(function (_a, ref) {
    ...
    return (React__default.createElement(NumberFormat, __assign$6({}, props, { getInputRef: ref, onValueChange: function (values) {
            if (onChange)
                onChange({ target: { value: values.value } });
        } })));
});
NumberFormatCustom.displayName = 'NumberFormatCustom';var FormNumberDefaultProps = __assign$6({}, FormTextDefaultProps);var FormNumber = React__default.forwardRef(function (_a, ref) {
    // Memo --------------------------------------------------------------------------------------------------------------
...
styleInject(css_248z$f);var FormSearch = React__default.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest$3(_a, ["className"]);
    return React__default.createElement(FormText, __assign$6({ className: classNames$1(className, 'FormSearch'), ref: ref, type: 'search' }, props));
});
...
styleInject(css_248z$e);var FormTextarea = React__default.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest$3(_a, ["className"]);
    return React__default.createElement(FormTextField, __assign$6({ ref: ref, className: classNames$1(className, 'FormTextarea') }, props, { multiline: true }));
});
FormTextarea.displayName = 'FormTextarea';
FormTextarea.defaultProps = FormTextareaDefaultProps;var FormUrlDefaultProps = __assign$6(__assign$6({}, FormTextDefaultProps), { validPattern: /^(?:http(s)?:\/\/)?[\w.-]+(?:\.[\w.-]+)+[\w\-._~:/?#[\]@!$&'%()*+,;=.]+$/gim });var FormUrl = React__default.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest$3(_a, ["className"]);
    return React__default.createElement(FormText, __assign$6({ ref: ref, className: classNames$1(className, 'FormUrl'), type: 'url' }, props));
});
...
styleInject(css_248z$c);var FormItemBase = React__default.forwardRef(function (_a, ref) {
    ...
    return (React__default.createElement("div", { style: wrapStyle },
        React__default.createElement(FormControl, { ref: ref, variant: 'standard', className: classNames$1(className, 'FormItemBase', !!label && 'with-label', "variant-".concat(variant), controlVerticalCenter && 'control-vertical-center', !!error && 'error'), style: style, color: color, error: error, focused: focused, sx: sx },
            ...
            !formColWithHelperText && helperText && (React__default.createElement(FormHelperText, __assign$6({ component: 'div' }, helperTextProps), helperText)))));
});
FormItemBase.displayName = 'FormItemBase';var FormCheckbox = React__default.forwardRef(function (_a, ref) {
    ...
    // Memo --------------------------------------------------------------------------------------------------------------
    var style = useMemo(function () { return (__assign$6({ width: fullWidth ? '100%' : width || 100, paddingLeft: 3 }, initStyle)); }, [initStyle, fullWidth, width]);
    // Function - focus ------------------------------------------------------------------------------------------------
    var focus = useCallback(function () {
        var _a, _b, _c, _d;
        if (initInputRef) {
...
var FormRadioGroup = React__default.forwardRef(function (_a, ref) {
    ...
    // Memo --------------------------------------------------------------------------------------------------------------
    var style = useMemo(function () { return (__assign$6({ width: width, paddingLeft: PADDING_LEFT }, initStyle)); }, [initStyle, width]);
    // Effect ----------------------------------------------------------------------------------------------------------
    useEffect(function () {
        if (value !== initValue) {
            if (onChange)
    ...
    return (React__default.createElement(FormItemBase, { focused: focused, ref: baseRef, className: classNames$1(className, 'FormValueItem', 'FormRadioGroup'), variant: variant, size: size, color: color, labelIcon: labelIcon, label: label, fullWidth: fullWidth, required: required, error: error, helperText: helperText, helperTextProps: { style: { marginLeft: 2 } }, style: style, sx: sx, hidden: hidden, controlHeight: height || (size === 'small' ? 35 : 39), controlVerticalCenter: true, control: React__default.createElement(React__default.Fragment, null,
            !fullWidth && !isOnGetItemLoading && !loading && items && (React__default.createElement("div", { ref: resizeWidthDetectorRef, style: {
                ...
                React__default.createElement(RadioGroup, __assign$6({}, props, { style: { marginTop: 10, display: 'inline-flex', flexWrap: 'nowrap' }, name: name, row: inline, value: value === undefined ? null : value, onChange: handleChange }), items.map(function (_a, idx) {
            ...
            React__default.createElement("div", null,
                React__default.createElement(RadioGroup, __assign$6({}, props, { style: {
                        marginTop: 10,
                        display: 'inline-flex',
...
styleInject(css_248z$b);var FormToggleButtonGroup = React__default.forwardRef(function (_a, ref) {
    ...
    return (React__default.createElement(FormItemBase, __assign$6({}, formControlBaseProps, { className: classNames$1(className, 'FormValueItem', 'FormToggleButtonGroup', "variant-".concat(variant), "size-".concat(size), !!label && 'with-label', !!fullWidth && 'full-width', "type-".concat(type)), variant: variant, size: size, color: color, labelIcon: labelIcon, label: label, required: required, fullWidth: fullWidth, error: error, helperText: helperText, helperTextProps: { style: { marginLeft: 2 } }, style: style, sx: sx, hidden: hidden, controlHeight: height || 0, controlVerticalCenter: isOnGetItemLoading || loading, control: isOnGetItemLoading || loading ? (React__default.createElement("div", { style: { opacity: 0.54 }, ref: resizeHeightDetectorRef },
            ...
            React__default.createElement(ToggleButtonGroup, { className: 'ToggleButtonGroup', exclusive: !multiple, fullWidth: fullWidth, value: value == null ? null : value, onChange: handleChange, style: {
                ...
                }, "aria-labelledby": notEmpty(label) ? labelId : undefined }, isOnGetItemLoading || loading || !items || empty(items) ? (React__default.createElement(ToggleButton, { ref: resizeHeightDetectorRef, size: size, className: 'ToggleButton', disabled: disabled || readOnly, value: '', style: { visibility: 'hidden' } })) : (buttons)))) })));
});
...
FormToggleButtonGroup.defaultProps = FormToggleButtonGroupDefaultProps;var FormRatingDefaultProps = {
    ...
    // Memo --------------------------------------------------------------------------------------------------------------
    var style = useMemo(function () { return (__assign$6({ width: width || 100 }, initStyle)); }, [initStyle, width]);
    // Effect ----------------------------------------------------------------------------------------------------------
    useEffect(function () {
        if (value !== initValue) {
            if (onChange)
...
styleInject(css_248z$9);var PrivateToggleButtonDefaultProps = {};var PrivateToggleButton = React__default.forwardRef(function (_a, ref) {
    ...
    return (React__default.createElement(Button, __assign$6({}, props, { ref: ref, sx: sx, variant: 'text', className: classNames$1(className, selected && 'selected') }), children));
});
...
var PrivateStaticDatePicker = React__default.forwardRef(function (_a, ref) {
    ...
    var LeftArrowButton = useState(function () {
        var ArrowButton = function (props) {
            ...
            return React__default.createElement(IconButton, __assign$6({}, props));
        };
        return ArrowButton;
    })[0];
    ...
    var handleRenderDay = useCallback(function (date, selectedDates, pickersDayProps) {
        return React__default.createElement(PickersDay, __assign$6({}, pickersDayProps, { selected: date.isSame(value, 'date') }));
    }, [value]);
    // Commands --------------------------------------------------------------------------------------------------------
    useLayoutEffect(function () {
        if (ref) {
            ...
            React__default.createElement(Grid, { container: true, direction: 'column' },
                ...
                React__default.createElement(Grid, { item: true, style: { position: 'relative' } },
                    React__default.createElement(StaticDatePicker, __assign$6({}, props, { value: activeMonthValue, defaultCalendarMonth: month, components: components, inputFormat: inputFormat, minDate: minDate, maxDate: maxDate, disablePast: disablePast, disableFuture: disableFuture, displayStaticWrapperAs: 'desktop', onChange: function (newValue, keyboardInputValue) {
                            ...
                            if (onMonthChange)
                                onMonthChange(month);
                        }, renderDay: handleRenderDay, renderInput: function (params) { return React__default.createElement(TextField, __assign$6({}, params)); } })),
...
PrivateStaticDatePicker.defaultProps = PrivateStaticDatePickerDefaultProps;var PrivateStyledTooltip = styled(function (_a) {
    var className = _a.className, props = __rest$3(_a, ["className"]);
    return (React__default.createElement(Tooltip, __assign$6({}, props, { classes: { popper: className } })));
})(function (_a) {
    var _b;
    var theme = _a.theme;
    return (_b = {},
        ...
        React__default.createElement(ClickAwayListener, { mouseEvent: 'onMouseDown', touchEvent: 'onTouchStart', onClickAway: function () { return setOpen(false); } },
            React__default.createElement("div", { className: classNames$1(className, 'PrivateDatePicker'), style: wrapStyle, onMouseDown: handleContainerMouseDown, onFocus: handleContainerFocus, onBlur: handleContainerBlur },
                React__default.createElement(PrivateStyledTooltip, { open: disabled || readOnly ? false : open, PopperProps: {
                    ...
                    }, title: React__default.createElement(PrivateStaticDatePicker, __assign$6({}, otherProps, { ref: privateStaticDatePickerRef, type: type, time: time, value: value, availableDate: availableDate, minDate: minDate, maxDate: maxDate, disablePast: disablePast, disableFuture: disableFuture, hours: hours, minutes: minutes, seconds: seconds, minuteInterval: minuteInterval, secondInterval: secondInterval, onChange: handleChange, onAccept: function () { return !time && setOpen(false); }, onClose: function () { return setOpen(false); } })) },
                    React__default.createElement("div", { style: { display: fullWidth ? 'block' : 'inline-block' } },
                        React__default.createElement(DesktopDatePicker, __assign$6({ value: inputValue, label: label, open: false, inputFormat: format, disabled: disabled, readOnly: readOnly, minDate: minDate, maxDate: maxDate, disablePast: disablePast, disableFuture: disableFuture, onClose: function () { return setOpen(false); }, onError: function (reason) { return (datePickerErrorRef.current = reason); }, onChange: function (newValue, keyboardInputValue) { return handleChange('date', newValue, keyboardInputValue); }, renderInput: function (_a) {
                                ...
                                return (React__default.createElement(TextField, __assign$6({}, params, { className: classNames$1(initClassName, 'input-text-field', "align-".concat(align)), inputRef: function (ref) {
                                        if (params.inputRef) {
...
PrivateAlertDialog.defaultProps = PrivateAlertDialogDefaultProps;var FormDatePicker = React__default.forwardRef(function (_a, ref) {
    ...
    // Render ----------------------------------------------------------------------------------------------------------
    return (React__default.createElement(FormContextProvider, { value: __assign$6({ onAddValueItem: handleAddValueItem }, otherFormState) },
        React__default.createElement(PrivateDatePicker, __assign$6({ className: classNames$1(className, 'FormDatePicker') }, props, { ref: ref, type: 'date' }))));
});
...
FormDatePicker.defaultProps = FormDatePickerDefaultProps;var FormDateTimePickerDefaultProps = {};var FormDateTimePicker = React__default.forwardRef(function (_a, ref) {
    ...
    // Render ----------------------------------------------------------------------------------------------------------
    return (React__default.createElement(FormContextProvider, { value: __assign$6({ onAddValueItem: handleAddValueItem }, otherFormState) },
        React__default.createElement(PrivateDatePicker, __assign$6({ className: classNames$1(className, 'FormDateTimePicker') }, props, { ref: ref, type: 'date_time' }))));
});
...
FormDateTimePicker.defaultProps = FormDateTimePickerDefaultProps;var FormTimePickerDefaultProps = {};var FormTimePicker = React__default.forwardRef(function (_a, ref) {
    ...
    // Render ----------------------------------------------------------------------------------------------------------
    return (React__default.createElement(FormContextProvider, { value: __assign$6({ onAddValueItem: handleAddValueItem }, otherFormState) },
        React__default.createElement(PrivateDatePicker, __assign$6({ className: classNames$1(className, 'FormTimePicker') }, props, { ref: ref, type: 'time' }))));
});
...
styleInject(css_248z$4);var CustomDatePicker = React__default.forwardRef(function (_a, ref) {
    ...
    var handleRenderDay = useCallback(function (date, selectedDates, pickersDayProps) {
        ...
        return (React__default.createElement("div", { key: pickersDayProps.key, style: { position: 'relative' } },
            ...
            React__default.createElement(PickersDay, __assign$6({}, pickersDayProps, { disableMargin: true, selected: date.isSame(startDate, 'date') || date.isSame(endDate, 'date'), onMouseEnter: value[0] || value[1] ? function () { return onMouseEnterPickersDay && onMouseEnterPickersDay(date); } : undefined }))));
    }, [value, getDateVal, baseClassNames, selectedClassNames, focusedClassNames, onMouseEnterPickersDay]);
    return (React__default.createElement(StaticDatePicker, { className: 'CustomDatePicker', displayStaticWrapperAs: 'desktop', components: components, value: activeMonthValue, defaultCalendarMonth: month, disableFuture: disableFuture, disablePast: disablePast, minDate: minDate, maxDate: maxDate, onChange: function (newValue) { return onValueChange && onValueChange(selectType, newValue); }, renderDay: handleRenderDay, renderInput: function (params) { return React__default.createElement(TextField, __assign$6({}, params)); }, inputFormat: 'YYYY-MM-DD HH:mm:ss', onMonthChange: function (month) {
            if (onMonthChange)
                onMonthChange(month);
            setActiveMonthValue(null);
        } }));
                ...
                React__default.createElement("div", { className: 'date-picker-wrap' },
                    React__default.createElement(Grid, { container: true, flexWrap: 'nowrap' },
                        React__default.createElement(Grid, { item: true },
                            React__default.createElement(CustomDatePicker, __assign$6({}, customDatePickerProps, { ref: datePicker1Ref, focusedDate: focusedDate, month: months[0], onMouseEnterPickersDay: setFocusedDate, onMonthChange: handleFirstDatePickerMonthChange }))),
                        React__default.createElement(Grid, { item: true, style: { borderLeft: '1px solid #efefef' } },
                            React__default.createElement(CustomDatePicker, __assign$6({}, customDatePickerProps, { ref: datePicker2Ref, focusedDate: focusedDate, month: months[1], onMouseEnterPickersDay: setFocusedDate }))),
                        Number(calendarCount) >= 3 && (React__default.createElement(Grid, { item: true, style: { borderLeft: '1px solid #efefef' } },
                            React__default.createElement(CustomDatePicker, __assign$6({}, customDatePickerProps, { ref: datePicker3Ref, focusedDate: focusedDate, month: months[2], onMouseEnterPickersDay: setFocusedDate }))))),
...
styleInject(css_248z$2);var InputDatePicker = function (_a) {
    ...
    // Render ----------------------------------------------------------------------------------------------------------
    return (React__default.createElement(DesktopDatePicker, __assign$6({}, props, { className: classNames$1(className, 'InputDatePicker', "align-".concat(align)), open: false, value: value, inputFormat: format, disabled: disabled, readOnly: readOnly || readOnlyInput, renderInput: function (_a) {
            ...
            !!hideUrl && (React__default.createElement("div", { className: 'input-file-wrap' },
                ...
                notEmpty(value) && (React__default.createElement(Button, { variant: 'outlined', className: 'remove-btn form-file-btn', color: error ? 'error' : color, disabled: disabled, onClick: handleRemoveClick },
                    React__default.createElement("label", null,
                        React__default.createElement(FormIcon, null, "Close"),
                        "\uC0AD\uC81C"))))),
            React__default.createElement(PrivateAlertDialog, __assign$6({}, alertDialogProps, { onClose: function () { return setAlertDialogProps({ open: false }); } })),
...
FormImageFile.defaultProps = FormImageFileDefaultProps;var SearchDefaultProps = {
    ...
    return (React__default.createElement(FormRow, __assign$6({}, props),
...
SearchGroupRow.defaultProps = SearchGroupRowDefaultProps;var Search = React__default.forwardRef(function (_a, ref) {
    ...
    return (React__default.createElement(FormContextProvider, { value: {
        ...
        React__default.createElement(Paper, { variant: 'outlined', className: className, sx: __assign$6({ p: 1.5 }, sx), style: style },
            React__default.createElement(Form, __assign$6({ ref: function (commands) {
                    if (ref) {
                        if (typeof ref === 'function') {
                            ref(commands);
                        }
