...
FormButton.defaultProps = FormButtonDefaultProps;var FormLabelDefaultProps = {};var IconFormIcon = styled(FormIcon)(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject(["\n  vertical-align: middle;\n  margin-right: 3px;\n  margin-top: -4px;\n  margin-bottom: -2px;\n"], ["\n  vertical-align: middle;\n  margin-right: 3px;\n  margin-top: -4px;\n  margin-bottom: -2px;\n"])));
var ChildrenSpan = styled('span')(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  vertical-align: middle;\n"], ["\n  vertical-align: middle;\n"])));
var templateObject_1$4, templateObject_2;var FormLabel = React__default.forwardRef(function (_a, ref) {
    // Memo --------------------------------------------------------------------------------------------------------------
    var children = _a.children, icon = _a.icon, size = _a.size, style = _a.style, props = __rest$2(_a, ["children", "icon", "size", "style"]);
    var finalProps = useMemo(function () { return (__assign$4(__assign$4({ shrink: true, className: 'FormItemBase-InputLabel', size: size === 'medium' ? 'normal' : size }, props), { style: __assign$4({ height: 20, transform: size === 'small' ? 'translate(0, -1.5px) scale(0.7)' : undefined }, style) })); }, [props, size, style]);
    // Render ------------------------------------------------------------------------------------------------------------
    return (React__default.createElement(InputLabel, __assign$4({ ref: ref }, finalProps), icon ? (React__default.createElement(React__default.Fragment, null,
...
}var StyledWrapGrid$1 = styled(Grid)(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["\n  width: 100%;\n"], ["\n  width: 100%;\n"])));
...
function useResizeDetector(props) {
    ...
    // State - style ---------------------------------------------------------------------------------------------------
    var style = useAutoUpdateLayoutState(useCallback(function () {
        if (hidden) {
            return __assign$4(__assign$4({}, initStyle), { display: 'none' });
        }
        else {
...
styleInject(css_248z$d);var FormSelect = React__default.forwardRef(function (_a, ref) {
    ...
    var inputLabelProps = useAutoUpdateLayoutState(useCallback(function () {
    ...
    var isSelectedPlaceholder = useAutoUpdateLayoutState(useCallback(function () {
...
FormItemBase.displayName = 'FormItemBase';var FormCheckbox = React__default.forwardRef(function (_a, ref) {
    ...
    // Memo --------------------------------------------------------------------------------------------------------------
    var style = useMemo(function () { return (__assign$4({ width: fullWidth ? '100%' : width || 100, paddingLeft: 3 }, initStyle)); }, [initStyle, fullWidth, width]);
    // Function - focus ------------------------------------------------------------------------------------------------
    var focus = useCallback(function () {
        var _a, _b, _c, _d;
        if (initInputRef) {
...
var FormRadioGroup = React__default.forwardRef(function (_a, ref) {
    ...
    // Memo --------------------------------------------------------------------------------------------------------------
    var style = useMemo(function () { return (__assign$4({ width: width, paddingLeft: PADDING_LEFT }, initStyle)); }, [initStyle, width]);
    // Effect ----------------------------------------------------------------------------------------------------------
    useEffect(function () {
        if (value !== initValue) {
            if (onChange)
...
FormToggleButtonGroup.defaultProps = FormToggleButtonGroupDefaultProps;var FormRatingDefaultProps = {
    ...
    // Memo --------------------------------------------------------------------------------------------------------------
    var style = useMemo(function () { return (__assign$4({ width: width || 100 }, initStyle)); }, [initStyle, width]);
    // Effect ----------------------------------------------------------------------------------------------------------
    useEffect(function () {
        if (value !== initValue) {
            if (onChange)
...
styleInject(css_248z$4);var CustomDatePicker = React__default.forwardRef(function (_a, ref) {
    ...
    var value = useAutoUpdateLayoutState(useCallback(function () {
...
var FormDateRangePicker = React__default.forwardRef(function (_a, ref) {
    ...
    var _k = useAutoUpdateLayoutState(useCallback(function () {
...
FormImageFile.defaultProps = FormImageFileDefaultProps;var SearchDefaultProps = {
    ...
    return (React__default.createElement(FormRow, __assign$4({}, props),
...
SearchGroup.defaultProps = SearchGroupDefaultProps;var SearchButtonDefaultProps = {};var SearchButton = function (_a) {
    ...
    var sx = useMemo(function () { return (__assign$4({ minWidth: 0, px: !startIcon && !endIcon && !icon ? 1.2 : 1.7 }, initSx)); }, [endIcon, icon, initSx, startIcon]);
    // Render ----------------------------------------------------------------------------------------------------------
