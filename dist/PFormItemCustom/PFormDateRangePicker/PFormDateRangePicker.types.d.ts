...
export interface PFormDateRangePickerProps extends PCommonSxProps, Omit<PFormValueItemProps<PFormDateRangePickerValue, false>, 'ref' | 'label' | 'labelIcon' | 'width'>, Pick<PrivateInputDatePickerProps, 'align'> {
