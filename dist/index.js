...
SearchGroup.defaultProps = SearchGroupDefaultProps;var SearchButtonDefaultProps = {};var SearchButton = function (_a) {
     ...
     * Render
     * ******************************************************************************************************************/
    return (React.createElement(reactComponent.PdgButton, __assign({ className: classNames(className, 'SearchButton'), size: util.ifUndefined(size, 'medium'), sx: sx, fullWidth: false, startIcon: startIcon, endIcon: endIcon, icon: icon }, props), children));
};
