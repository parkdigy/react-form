...
export interface PFormHiddenProps extends Pick<PFormTextFieldProps<PFormHiddenValue>, 'className' | 'name' | 'value' | 'error' | 'required' | 'exceptValue' | 'onChange' | 'onValue' | 'onValidate'> {
